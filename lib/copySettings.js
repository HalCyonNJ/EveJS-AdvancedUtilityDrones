...
// The identifier grammar behind "/aud copy".
//
...
// different rocks. "/aud copy <who>" takes another character's stored entry out
...
// "/aud copy example", "/aud copy miner example" and a half-remembered spelling
...
// who never changed anything has nothing to copy, and "/aud clear" already
...
// EVEJS_ADVANCED_UTILITY_DRONES_ALLOW_PLAYER_COPY=0 removes the command entirely.
...
// is for the caller to report rather than guess between. "/aud copy list"
// wants them all, "/aud copy <who>" wants exactly one, and both read the query
// the same way.
...
// One source for "/aud copy <who>": { characterID, entry } or
...
// alone, and /aud clear removes the entry altogether.
