...
const OVERLAY_VERSION = "1.0.2-beta.1";
const OVERLAY_MARKER = Symbol.for("evejs.betaAdvancedUtilityDrones.plainChat");
const FALLBACK_MESSAGE = "beta-AdvancedUtilityDrones: the command produced no reply.";
  ...
  for (const channel of CHANNELS) {
    ...
    const wrapped = function advancedUtilityDronesPlainChat() {
      ...
      try {
        ...
        message = `beta-AdvancedUtilityDrones: the command failed (${error && error.message}).`;
      }
