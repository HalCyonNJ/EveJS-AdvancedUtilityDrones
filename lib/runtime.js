...
function createRuntime(options) {
  ...
  function warnAboutWreck(characterID, wreckID, access, blocking) {
    ...
    const text = blocking
      ...
      : "AdvancedUtilityDrones warning: wreck " + wreckID + " belongs to " + owner +
        " - salvaging it makes you a suspect. \"/aud s foreign off\" keeps the salvage " +
        "drones on your own wrecks.";
    let sent = false;
    try {
  ...
  function runSalvageShipPass(scene, controllerID, shipDrones, nowMs, claims) {
    ...
    for (const wreck of wrecks) {
      ...
      if (access.blocked) {
        warnAboutWreck(characterID, wreck.targetID, access, true);
        continue;
      }
      if (!access.entitled) {
        ...
        if (settings.foreign === SALVAGE_FOREIGN_WARN) {
          warnAboutWreck(characterID, wreck.targetID, access, false);
        }
      }
