...
const SALVAGE_HELP_LINES = Object.freeze([
  ...
  "    another pilot's left alone with a warning line, or another pilot's anyway",
  ...
  "A wreck that is not yours is the game's question, not this mod's: it is worked",
  "only under \"foreign allow\", and the game's safety light is never overridden.",
]);
...
function describeSalvageForeign(foreign) {
  ...
  if (foreign === "warn") {
    return "warn (another pilot's wreck is left alone, and named once per launch)";
  }
