...
const SALVAGE_HELP_LINES = Object.freeze([
  ...
  "/aud salvage spread|focus - one wreck per drone, or every drone on the same wreck",
  ...
  "    sa, and then sa on, sa off, sa sp, sa fo, sa ds, sa rg, sa th, sa ls,",
  "    sa ct, sa rs, sa cl, sa st, sa h. Nothing else is accepted, and what a",
  "    command takes is always typed in full - nearest, farthest, ship, hold,",
  "    recall or off. \"/aud sa ds farthest\" is \"/aud salvage distance farthest\".",
  "\"/aud copy <name|id>\" takes a whole setup - both kinds - onto you, and",
  "\"/aud clear\" clears both kinds at once",
